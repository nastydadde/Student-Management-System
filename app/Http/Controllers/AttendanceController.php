...
class AttendanceController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($isSuperAdmin) {
            $students = Student::with('attendances')->when($search, function ($query, $search) {
            ...
            return view('admin.attendance', compact('students', 'search', 'department', 'school', 'departments', 'schools', 'semester', 'semesters', 'division', 'divisions'));
        } else {
