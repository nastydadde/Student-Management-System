...
class ContactsController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($isSuperAdmin) {
            $contacts = Student::with('contact')->orderBy('id', 'desc')
            ...
            return view('admin.contacts', compact('contacts', 'search', 'department', 'school', 'departments', 'schools', 'semester', 'semesters', 'division', 'divisions'));
        } else {
            ...
            $contacts = Student::with(['contact', 'followups', 'attendances', 'results', 'summary'])
